...
const uiCopy: Record<AppLocale, UiCopy> = {
  "zh-CN": {
    ...
    "roles.viewCards": "卡片视图",
    "roles.viewThumbs": "头像视图",
    "roles.clone": "复制角色",
    "roles.sync": "回流经验",
    "roles.stockCount": "{count} 个角色",
    "roles.cardLabel": "角色卡片",
    "roles.avatarLabel": "角色头像",
    "equipment.title": "装备库",
  ...
  "en-US": {
    ...
    "home.title": "Two AI workers pair program.\nYou wait for the harvest.",
    ...
    "roles.viewCards": "Card View",
    "roles.viewThumbs": "Avatar View",
    "roles.clone": "Clone Role",
    "roles.sync": "Sync Back",
    "roles.stockCount": "{count} roles",
    "roles.cardLabel": "Role Card",
    "roles.avatarLabel": "Role Avatar",
